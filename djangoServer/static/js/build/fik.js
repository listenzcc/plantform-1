(function (global, factory) {
    ...
    var _Math = {
        ...
        genPerpendicularVectorQuick: function (v) {
            ...
            return Math.abs(v.y) < 0.99
                ? p.set(-v.z, 0, v.x).normalize()
                : p.set(0, v.z, -v.y).normalize();
        },
        ...
        validateDirectionUV: function (directionUV) {
            if (directionUV.length() < 0)
                Tools.error("vector direction unit vector cannot be zero.");
        },

        validateLength: function (length) {
            if (length < 0)
                Tools.error("Length must be a greater than or equal to zero.");
        },
    };
    ...
    Object.assign(V3.prototype, {
        ...
        constrainedUV: function (referenceAxis, rotationAxis, mtx, min, max) {
            ...
            if (angle > max)
                this.copy(
                    mtx.rotateAboutAxis(referenceAxis, max, rotationAxis)
                );
            if (angle < min)
                this.copy(
                    mtx.rotateAboutAxis(referenceAxis, min, rotationAxis)
                );
            return this;
        },
    ...
    Object.assign(Bone3D.prototype, {
        ...
        init: function (startLocation, endLocation, directionUV, length) {
            ...
            if (endLocation) {
                ...
                this.setEndLocation(
                    this.start.plus(
                        directionUV.normalised().multiplyScalar(length)
                    )
                );
            }
        },
    ...
    Object.assign(Chain3D.prototype, {
        ...
        clone: function () {
            ...
            if (!(this.baseboneConstraintType === NONE)) {
                ...
                c.baseboneRelativeConstraintUV.copy(
        ...
        addConsecutiveFreelyRotatingHingedBone: function (
            directionUV,
            length,
            type,
            hingeRotationAxis
            ...
            this.addConsecutiveHingedBone(
                ...
                180,
                180,
                _Math.genPerpendicularVectorQuick(hingeRotationAxis)
            );
        },

        addConsecutiveHingedBone: function (
            DirectionUV,
            length,
            type,
            HingeRotationAxis,
        ...
        addConsecutiveRotorConstrainedBone: function (
            boneDirectionUV,
            length,
            constraintAngleDegs
        ) {
        ...
        setRotorBaseboneConstraint: function (type, constraintAxis, angleDegs) {
            ...
            this.baseboneConstraintType =
                type === "global" ? GLOBAL_ROTOR : LOCAL_ROTOR;
        ...
        setHingeBaseboneConstraint: function (
            type,
            hingeRotationAxis,
            cwDegs,
            acwDegs,
            ...
            // Set the constraint type, axis and angle
            this.baseboneConstraintType =
                type === "global" ? GLOBAL_HINGE : LOCAL_HINGE;
            this.baseboneConstraintUV = hingeRotationAxis.normalised();
            this.bones[0].joint.setHinge(
                type === "global" ? J_GLOBAL : J_LOCAL,
                hingeRotationAxis,
                cwDegs,
                acwDegs,
        ...
        setGlobalHingedBasebone: function (
            hingeRotationAxis,
            cwDegs,
            acwDegs,
            hingeReferenceAxis
        ...
        setLocalHingedBasebone: function (
            hingeRotationAxis,
            cwDegs,
            acwDegs,
            hingeReferenceAxis
        ...
        solveForTarget: function (t) {
            ...
            var isSameBaseLocation = this.lastBaseLocation.approximatelyEquals(
                this.baseLocation,
                p
            );
            ...
            if (
                this.lastTargetLocation.approximatelyEquals(
                    this.tmpTarget,
                    p
                ) &&
                isSameBaseLocation
            ...
            if (isSameBaseLocation) {
                startingDistance = this.bones[this.numBones - 1].end.distanceTo(
                    this.tmpTarget
                );
        ...
        solveIK: function (target) {
            ...
            while (i--) {
                ...
                if (i !== this.numBones - 1) {
                    ...
                    var outerBoneOuterToInnerUV = nextBone
                        .getDirectionUV()
                        .negate();
                    ...
                    switch (jointType) {
                        ...
                        case J_GLOBAL:
                            ...
                            // Project this bone outer-to-inner direction onto the hinge rotation axis
                            boneOuterToInnerUV.projectOnPlane(
                                hingeRotationAxis
                            );
                        ...
                        case J_LOCAL:
                            if (i > 0) {
                                ...
                                tmpMtx.createRotationMatrix(
                                    this.bones[i - 1].getDirectionUV()
                                );
                                hingeRotationAxis = joint
                    ...
                    var newStartLocation = bone.end.plus(
                        boneOuterToInnerUV.multiplyScalar(boneLength)
                    );
                    ...
                    if (i > 0)
                        this.bones[i - 1].setEndLocation(newStartLocation);
                } else {
                    ...
                    var newStartLocation = target.plus(
                        boneOuterToInnerUV.multiplyScalar(boneLength)
                    );
                ...
                if (i !== 0) {
                    ...
                    switch (jointType) {
                        ...
                        case J_GLOBAL:
                            ...
                            boneInnerToOuterUV.projectOnPlane(
                                hingeRotationAxis
                            );

                            // Constrain rotation about reference axis if required
                            if (!joint.freeHinge)
                                boneInnerToOuterUV.constrainedUV(
                                    hingeReferenceAxis,
                                    hingeRotationAxis,
                                    tmpMtx,
                                    joint.min,
                    ...
                    // so we can set the new inner joint location to be the end joint location of this bone plus the
                    // outer-to-inner direction unit vector multiplied by the length of the bone.
                    var newEndLocation = bone.start.plus(
                        boneInnerToOuterUV.multiplyScalar(boneLength)
                    );
                    ...
                    if (this.fixedBaseMode) {
                        ...
                        bone.setStartLocation(
                            bone.end.minus(
                                bone.getDirectionUV().multiplyScalar(boneLength)
                            )
                        );
                    }
                    ...
                    switch (this.baseboneConstraintType) {
                        ...
                        case LOCAL_HINGE:
                            hingeRotationAxis =
                                this.baseboneRelativeConstraintUV;
                            hingeReferenceAxis =
                                this.baseboneRelativeReferenceConstraintUV;
    ...
    Object.assign(Structure3D.prototype, {
        update: function () {
            ...
            for (var i = 0; i < this.numChains; i++) {
                ...
                if (hostChainNumber !== -1) {
                    hostBone =
                        this.chains[hostChainNumber].bones[
                            chain.getConnectedBoneNumber()
                        ];

                    chain.setBaseLocation(
                        chain.getBoneConnectionPoint() === START
                            ? hostBone.start
                            : hostBone.end
                    );
                    ...
                    switch (constraintType) {
                        ...
                        case LOCAL_HINGE:
                            ...
                            this.tmpMtx.createRotationMatrix(
                            ...
                            var relativeBaseboneConstraintUV = chain
                                .getBaseboneConstraintUV()
                                .clone()
                                .applyM3(this.tmpMtx);

                            // Update our basebone relative constraint UV property
                            chain.setBaseboneRelativeConstraintUV(
        ...
        connectChain: function (
            ...
            var position =
                point === "end"
                    ? this.chains[c].bones[n].end
                    : this.chains[c].bones[n].start;
        ...
        addChainMeshs: function (chain, id) {
            ...
            for (var i = 0; i < lng; i++) {
                meshBone.push(
                    this.addBoneMesh(chain.bones[i], i - 1, meshBone, chain)
                );
            }
        ...
        addBoneMesh: function (bone, prev, ar, chain) {
            ...
            g.applyMatrix(
                new THREE.Matrix4().makeTranslation(0, 0, size * 0.5)
            );
            ...
            switch (type) {
                case J_BALL:
                    ...
                    var s = 2; //size/4;
                    var r = 2; //
                    extraGeo = new THREE.CylinderBufferGeometry(
                        0,
                        r,
                        s,
                        6,
                    ...
                    extraGeo.applyMatrix(
                        new THREE.Matrix4().makeRotationX(-Math.PI * 0.5)
                    );
                    extraGeo.applyMatrix(
                        new THREE.Matrix4().makeTranslation(0, 0, s * 0.5)
                    );
                ...
                case J_GLOBAL:
                    ...
                    extraGeo = new THREE.CircleBufferGeometry(
                        r,
                        12,
                        a1,
                        -a1 + a2
                ...
                case J_LOCAL:
                    ...
                    if (axe.x === 1)
                        extraGeo.applyMatrix(
                            new THREE.Matrix4().makeRotationZ(-Math.PI * 0.5)
                        );
                    if (axe.y === 1) {
                        extraGeo.applyMatrix(
                            new THREE.Matrix4().makeRotationX(Math.PI * 0.5)
    ...
    function Bone2D(
        ...
        if (End) {
            ...
            this.setEndLocation(
                this.start.plus(
                    directionUV.normalised().multiplyScalar(this.length)
                )
            );
        }
    }
    ...
    Object.assign(Chain2D.prototype, {
        ...
        setFixedBaseMode: function (value) {
            // Enforce that a chain connected to another chain stays in fixed base mode (i.e. it moves with the chain it's connected to instead of independently)
            if (!value && this.connectedChainNumber !== -1) return;
            if (this.baseboneConstraintType === GLOBAL_ABSOLUTE && !value)
                return;
            // Above conditions met? Set the fixedBaseMode
            this.fixedBaseMode = value;
        },
        ...
        solveIK: function (target) {
            ...
            while (i--) {
                ...
                if (i !== this.numBones - 1) {
                    ...
                    // Get the outer-to-inner unit vector of the bone further out
                    baselineUV =
                        bone.joint.coordinateSystem === J_LOCAL
                            ? nextBone.getDirectionUV().negate()
                            : bone.getGlobalConstraintUV().negated();
                    directionUV.constrainedUV(
                        baselineUV,
                        nextBone.joint.min,
                        nextBone.joint.max
                    );
                    ...
                    // so we can set the new inner joint location to be the end joint location of this bone plus the
                    // outer-to-inner direction unit vector multiplied by the length of the bone.
                    startPosition = bone.end.plus(
                        directionUV.multiplyScalar(boneLength)
                    );
                    ...
                    if (i > 0) {
                        ...
                        baselineUV =
                            bone.joint.coordinateSystem === J_LOCAL
                                ? this.bones[i - 1].getDirectionUV().negate()
                                : bone.getGlobalConstraintUV().negated();
                        directionUV.constrainedUV(
                            baselineUV,
                            bone.joint.min,
            ...
            for (i = 0; i < this.numBones; i++) {
                ...
                if (i !== 0) {
                    ...
                    if (this.baseboneConstraintType === NONE) {
                        ...
                        baselineUV =
                            this.baseboneConstraintType === LOCAL_ABSOLUTE
                                ? this.baseboneRelativeConstraintUV
                                : this.baseboneConstraintUV;
                        directionUV.constrainedUV(
                            baselineUV,
    ...
    Object.assign(Structure2D.prototype, {
        ...
        update: function () {
            ...
            for (var i = 0; i < this.numChains; i++) {
                ...
                if (
                    hostChainNumber !== -1 &&
                    constraintType !== GLOBAL_ABSOLUTE
                ) {
                    ...
                    if (constraintType === LOCAL_RELATIVE) {
                        ...
                        var relativeConstraintUV = chain
                            .getBaseboneConstraintUV()
                            .clone()
                            .rotate(angle);
    ...
    Object.assign(HISolver.prototype, {
        ...
        update: function () {
            ...
            for (var i = 0; i < n; i++) {
                a =
                    i === 0
                        ? _Math.findAngle(this.fakeBone, bones2d[i])
                        : _Math.findAngle(bones2d[i - 1], bones2d[i]);
